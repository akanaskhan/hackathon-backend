...
import LoanRequestModel from "../models/index.js";
import chalk from "chalk";

export const addLoanRequest = (data) => {
  return new LoanRequestModel({ ...data })
    .save()
    .then((request) => (request ? request.toObject() : null))
    .catch((err) => {
